 ...
 *
 * Not final only so {@see TwoEntityManagersGedmoKernel} can add a second manager to exactly this
 * arrangement: the point of that test is the listener ordering being realistic, not a second setup.
 *
 ...
 */
class GedmoBridgeKernel extends TestKernel
{
    ...
    /**
     * Only the events the installed Gedmo actually implements are registered — see
     * {@see GedmoKernel::listenTo()} for why tagging blindly breaks the lowest dependency cell.
     */
