...
abstract class GedmoBridgeTestCase extends AuditTrailKernelTestCase
{
     ...
     */
    protected function translationAuditListener(?EntityManagerInterface $auditedEntityManager = null): TranslationAuditListener
    {
        $entityManager = $auditedEntityManager ?? $this->em();
        $auditableResolver = new AuditableResolver($this->em());
        $entityIdResolver = new EntityIdResolver($this->em());
        ...
        return new TranslationAuditListener(
            ...
            scopeResolver: new DefaultScopeResolver($auditableResolver, $entityIdResolver, $labelResolver, new AuditTypeResolver()),
