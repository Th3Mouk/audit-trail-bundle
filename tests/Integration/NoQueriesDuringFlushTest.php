...
final class NoQueriesDuringFlushTest extends IntegrationTestCase
{
    ...
    public function testCaptureAddsNoStatementToAFlushDoctrineAlreadyHadToMake(): void
    {
        ...
        // Three, not one: cascade suppression is opt-in, so the root and both cascaded children are
        // each recorded. What matters here is only that capture really ran.
        self::assertSame(3, $this->countAuditRows(), 'The measured flush must really have been captured.');
